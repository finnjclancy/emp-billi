#!/usr/bin/env python3
"""
Fixed test file for finding token values using Etherscan and pool contracts.
...
def calculate_token_usd_value(pool_info: Dict) -> Optional[Dict]:
    ...
    if token0_is_weth:
        ...
        other_token_price_in_weth = pool_info['price_token1_per_token0']  # How much other token for 1 WETH
        weth_price_in_other = pool_info['price_token0_per_token1']  # How much WETH for 1 other token
        ...
        other_token_price_in_weth = pool_info['price_token0_per_token1']  # How much other token for 1 WETH
        weth_price_in_other = pool_info['price_token1_per_token0']  # How much WETH for 1 other token
...
def main():
    """Main test function"""
    print("🧪 Testing Token Value Calculation from Pool Contracts (Fixed)")
    print("=" * 70)
